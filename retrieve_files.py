...
host = 'perlmutter'
username = 'vandelij'
parent_direc = '/global/homes/v/vandelij/aorsa3/aorsa/jacob_local/shots/DIIID147634'# '/global/homes/j/jwright/perlmutter-builds/aorsa/examples/DIIID-helicon'#'~/AORSA/DIIID-helicon/'  #'~/AORSA/DIIID-helicon/'
